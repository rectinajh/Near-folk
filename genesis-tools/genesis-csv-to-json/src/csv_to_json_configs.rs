use near_chain_configs::{
    ...
    MAX_INFLATION_RATE, MIN_GAS_PRICE, NBC_BASE, NUM_BLOCK_PRODUCER_SEATS, NUM_BLOCKS_PER_YEAR,
...
fn verify_total_supply(total_supply: Balance, chain_id: &str) {
    if chain_id == near_primitives::chains::MAINNET {
        assert_eq!(
            total_supply,
            1_000_000_000 * NBC_BASE,
            "Total supply should be exactly 1 billion"
        );
    } else if total_supply > 10_000_000_000 * NBC_BASE
