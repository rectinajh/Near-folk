...
use near_chain_configs::{Genesis, GenesisConfig, GenesisValidationMode, NBC_BASE};
...
impl ForkNetworkCommand {
    ...
    fn read_validators(validators: &Path, home_dir: &Path) -> anyhow::Result<Vec<AccountInfo>> {
        ...
        let account_infos = new_validators
            ...
            .map(|v| AccountInfo {
                ...
                amount: v.amount.unwrap_or(50_000 * NBC_BASE),
            })
            .collect();
        Ok(account_infos)
    }
    ...
    fn add_validator_accounts(
        ...
        let liquid_balance = 100_000_000 * NBC_BASE;
